...
#' @param temppars temppar values
#' @param deckchoices deckchoice values
#' @param wins win values
#' @param losses loss values
#' @return returns ppmat
#' @examples
#' # Filterrlcpredpfun(temppars, deckchoices, wins, losses)
#' @export
...
Filterrlcpredpfun = function(temppars, deckchoices, wins, losses)
{
  ...
  losses <-
    as.numeric(as.character(losses)) # convert this column from string to numeric
